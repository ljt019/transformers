...
fn main() -> Result<()> {
    ...
    let pipeline_1 = TextGenerationPipelineBuilder::qwen3(Qwen3Size::Size4B)
        .temperature(0.7)
        .max_len(10)
        .build()?;
    ...
    let pipeline_2 = TextGenerationPipelineBuilder::qwen3(Qwen3Size::Size4B)
        .temperature(0.7)
        .max_len(10)
        .build()?;
    ...
    let pipeline_3 = TextGenerationPipelineBuilder::qwen3(Qwen3Size::Size4B)
        .temperature(0.7)
        .max_len(10)
        .build()?;
    ...
    let pipeline_4 = TextGenerationPipelineBuilder::qwen3(Qwen3Size::Size4B)
        .temperature(0.7)
        .max_len(10)
        .build()?;
    ...
    let pipeline_5 = TextGenerationPipelineBuilder::qwen3(Qwen3Size::Size4B)
        .temperature(0.7)
        .max_len(10)
        .build()?;
    ...
    let pipeline_6 = TextGenerationPipelineBuilder::qwen3(Qwen3Size::Size4B)
        .temperature(0.7)
        .max_len(10)
        .build()?;
    ...
    let pipeline_7 = TextGenerationPipelineBuilder::qwen3(Qwen3Size::Size4B)
        .temperature(0.7)
        .max_len(10)
        .build()?;
    ...
    let pipeline_8 = TextGenerationPipelineBuilder::qwen3(Qwen3Size::Size4B)
        .temperature(0.7)
        .max_len(10)
        .build()?;
    ...
    let pipeline_9 = TextGenerationPipelineBuilder::qwen3(Qwen3Size::Size4B)
        .temperature(0.7)
        .max_len(10)
        .build()?;
    ...
    let pipeline_10 = TextGenerationPipelineBuilder::qwen3(Qwen3Size::Size4B)
        .temperature(0.7)
        .max_len(10)
        .build()?;
